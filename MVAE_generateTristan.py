...
output_dir = '/Users/carsault/Dropbox/work/code/gitlab/acids-live/mathieu_MusicVAE/MVAE_output'
input_output_dir = '/Users/carsault/Dropbox/work/code/gitlab/acids-live/mathieu_MusicVAE/MVAE_input_valid'
...
input_midi_1 = os.path.expanduser(input_files_list[style_name.index(arguments['<style1>'])])
input_midi_2 = os.path.expanduser(input_files_list[style_name.index(arguments['<style2>'])])
input_midi_3 = os.path.expanduser(input_files_list[style_name.index(arguments['<style3>'])])
input_midi_4 = os.path.expanduser(input_files_list[style_name.index(arguments['<style4>'])])
...
z_new = z[0]*float(arguments['<val1>']) + z[1]*float(arguments['<val2>']) + z[2]*float(arguments['<val3>']) + z[3]*float(arguments['<val4>'])
z_new_2 = z_new + 0.05
